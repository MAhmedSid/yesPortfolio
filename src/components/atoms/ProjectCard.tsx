...
const ProjectCard: React.FC<{
  ...
  return (
    <div className="group relative h-72 cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 md:h-96">
      ...
      <div className="absolute inset-0 h-full bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/90 group-hover:to-black/80"></div>
